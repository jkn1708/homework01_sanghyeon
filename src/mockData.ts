...
let ChatBoxDatas1: IChatBox[] = [
  { id: "chat1", name: "하하", chatContent: "안녕하세요", isMe: false },
  { id: "chat2", name: "재석", chatContent: "반갑습니다", isMe: true },
  { id: "chat3", name: "준하", chatContent: "처음뵙겠습니다", isMe: false },
];

let ChatBoxDatas2: IChatBox[] = [
  { id: "chat1", name: "삐삐", chatContent: "반가워", isMe: false },
  { id: "chat2", name: "삐삐", chatContent: "호호", isMe: false },
  { id: "chat3", name: "준하", chatContent: "굿나잇", isMe: false },
];

let ChatBoxDatas3: IChatBox[] = [
  { id: "chat1", name: "하하", chatContent: "나이가", isMe: false },
  { id: "chat2", name: "재석", chatContent: "30", isMe: true },
  { id: "chat3", name: "하하", chatContent: "오키", isMe: false },
];
...
export let ChatRoomBoxDatas: IChatRoomBox[] = [
  { id: "room1", name: "단체방1", chatList: ChatBoxDatas1 , userList : userList1 },
